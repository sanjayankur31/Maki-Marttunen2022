...
syn1.onset = 200
  """)
    ...
    scipy.io.savemat('fI2_Ihcoeff'+str(Ihcoeff)+'_tmp.mat',{'spikfreqs': spikfreqs, 'spikfreqs2': spikfreqs2, 'spikes': spikes, 'spikes2': spikes2, 'Vsoma': Vsoma, 'Vdend': Vdend, 'Casoma': Casoma, 'Cadend': Cadend})
  
scipy.io.savemat('fI2_Ihcoeff'+str(Ihcoeff)+'.mat',{'spikfreqs': spikfreqs, 'spikfreqs2': spikfreqs2, 'spikes': spikes, 'spikes2': spikes2, 'Vsoma': Vsoma, 'Vdend': Vdend, 'Casoma': Casoma, 'Cadend': Cadend})
