...
L5PC.apic[siteVec[0]] cvode.record(&ihcn_Ih(siteVec[1]),ihdend,tvec)
...
""")
    ...
    file = open('nohotLVA_strongdendcondthresh'+str(denddist)+'_Ihcoeff'+str(Ihcoeff)+'_absbound.sav', 'wb')
